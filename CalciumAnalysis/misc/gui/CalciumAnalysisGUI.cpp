...
std::string InstantSuite::GetMenuName()
{
	return "instantsuite";
}
...
std::string InstantSuite::GetMenuTitle()
{
	return menuTitle;
}

/// <summary>Sets the ImGui context.</summary>
void InstantSuite::SetImGuiContext(const uintptr_t ctx)
{
...
bool InstantSuite::ShouldBlockInput()
{
...
bool InstantSuite::IsActiveOverlay()
{
	return true;
}

/// <summary>Sets the window to open.</summary>
void InstantSuite::OnOpen()
{
	isWindowOpen = true;
}

/// <summary>Sets the window to close.</summary>
void InstantSuite::OnClose()
{
	isWindowOpen = false;
}
...
void InstantSuite::renderInstantSettingsTab()
{
...
/// </summary>
void InstantSuite::renderKeybindsTab()
{
...
//bool InstantSuite::renderCustomMapsSelection(std::map<std::filesystem::path, std::string>& customMaps, std::filesystem::path& currentCustomMap, bool& refreshCustomMaps, const bool includeWorkshopMaps, const bool includeCustomMaps)
//{

...
extern std::filesystem::path InstantSuiteDataFolder;
...
#define COPIED_MAPS_PATH       (COOKED_PC_CONSOLE_PATH / "InstantSuite")
...
class InstantSuite : public BakkesMod::Plugin::BakkesModPlugin, public BakkesMod::Plugin::PluginWindow
{
...
private:
	...
	std::string menuTitle = "instantsuite";
public:
	virtual void Render();

...
def get_tastant_dicts(tastant,
    ...
    return dct_base_dict, dct_norm_dict, dct_zscore_dict, dct_sw_dict, dct_sz_dict, dct_window_dict, dct_sig_dict, dct_pct_dict

def get_single_tastant_dicts(tastant,
              cells,
              alldata: Optional[list | str] = [],
              baseline: int | float = 1,
              do_signal=False,
